...
<body>
    <form action="/docs/create_board.php" method="post">
        <div>
            <p>글 제목:<input type="text" name="board_name"  required/></p>
            <br>
			<p>글 내용:<textarea  name="description"  required></textarea></p>
            <br>
            <input type="submit" value="글 등록" />
			<a href="https://colony-team-ebmke.run.goorm.io/docs/main_board.php">돌아가기</a>
        </div>
    </form>
</body>
<?php }
...
// 	sql injection filter
    ...
    $board_description=mysqli_real_escape_string($con,$_POST['description']);
		
//  xss filter
	$Filter_name=RemoveXSS($board_name);
	$Filter_des=RemoveXSS($board_description);
		
		
    $sql="INSERT INTO board(board_name,board_index,created_date,writer) VALUES('{$Filter_name}','{$Filter_des}',NOW(),'{$_SESSION['login_id']}')";
